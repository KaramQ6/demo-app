...
import { Globe, Menu, X, User, LogOut, MapPin, MessageCircle } from 'lucide-react';
...
const Header = () => {
  ...
  const isAdmin = user?.email === 'admin@smarttour.jo' || user?.role === 'admin';

  // Navigation items
  const primaryNavigation = [
    { path: '/', label: { ar: 'الرئيسية', en: 'Home' }, public: true },
    { path: '/destinations', label: { ar: 'الوجهات', en: 'Destinations' }, public: true },
    { path: '/booking', label: { ar: 'حجز رحلة', en: 'Book Tour' }, public: true },
    { path: '/about', label: { ar: 'حول', en: 'About' }, public: true }
  ];

  const secondaryNavigation = [
    { path: '/my-plan', label: { ar: 'خطتي', en: 'My Plan' }, public: false },
    { path: '/profile', label: { ar: 'ملفي الشخصي', en: 'Profile' }, public: false },
    ...(isAdmin ? [{ path: '/admin', label: { ar: 'لوحة الإدارة', en: 'Admin' }, public: false }] : [])
  ];
